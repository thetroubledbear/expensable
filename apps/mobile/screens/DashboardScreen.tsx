...
function StatCard({ label, value, sub, positive }: { label: string; value: string; sub?: string; positive?: boolean }) {
  return (
    <Card style={styles.statCard}>
      ...
      <Text style={[styles.statValue, positive !== undefined && (positive ? styles.green : styles.red)]}>{value}</Text>
...
export default function DashboardScreen() {
  ...
  async function loadExtras() {
    // Fire all in parallel — each failure is isolated
...
async function enableSocialComparison() {
  ...
  if (loading) {
    return <View style={styles.center}><ActivityIndicator color="#059669" size="large" /></View>
  }
          ...
          {data.trend.length > 1 && (
            <Card>
                  ...
                  return data.trend.map((t, i) => (
                    <View key={i} style={styles.trendCol}>
                      <View style={styles.trendBars}>
                        <View style={[styles.trendBar, styles.trendBarSpent, { height: Math.max(4, (t.spent / maxVal) * 60) }]} />
                        <View style={[styles.trendBar, styles.trendBarReceived, { height: Math.max(4, (t.received / maxVal) * 60) }]} />
                      </View>
              ...
              <View style={styles.trendLegend}>
                <View style={styles.legendItem}><View style={[styles.legendDot, { backgroundColor: "#ef4444" }]} /><Text style={styles.legendText}>Spent</Text></View>
                <View style={styles.legendItem}><View style={[styles.legendDot, { backgroundColor: "#059669" }]} /><Text style={styles.legendText}>Received</Text></View>
              </View>
            </Card>
          )}
        </>
...
const styles = StyleSheet.create({
  ...
  alertText: { flex: 1, fontSize: 12, color: "#92400e", lineHeight: 18 },
  alertBold: { fontWeight: "700" },
  alertDismiss: { fontSize: 14, color: "#d97706", padding: 2 },
  ...
  modalCard: { backgroundColor: "#fff", borderRadius: 20, padding: 20, width: "100%", maxWidth: 420, shadowColor: "#000", shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.15, shadowRadius: 24, elevation: 12 },
  ...
  voiceHint: { fontSize: 13, color: "#64748b", textAlign: "center", marginBottom: 20, lineHeight: 20 },
  ...
  processingLabel: { fontSize: 14, color: "#64748b" },
  processingTranscript: { fontSize: 12, color: "#94a3b8", fontStyle: "italic", marginTop: 4 },
  successHeader: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 14 },
  successCheck: { fontSize: 18 },
  successLabel: { fontSize: 14, fontWeight: "500", color: "#059669" },
  ...
  resultKey: { fontSize: 12, color: "#94a3b8" },
  resultVal: { fontSize: 13, fontWeight: "600", color: "#0f172a" },
  voiceActions: { flexDirection: "row", gap: 8, marginTop: 14 },
  voiceSecondaryBtn: { flex: 1, borderWidth: 1, borderColor: "#e2e8f0", borderRadius: 12, paddingVertical: 10, alignItems: "center" },
  voiceSecondaryBtnText: { fontSize: 13, color: "#64748b" },
  voicePrimaryBtn: { flex: 1, backgroundColor: "#059669", borderRadius: 12, paddingVertical: 10, alignItems: "center" },
  voicePrimaryBtnText: { fontSize: 13, fontWeight: "600", color: "#fff" },
  voiceErrorText: { fontSize: 13, color: "#ef4444", textAlign: "center", marginBottom: 16 },

  // Trade-offs (shared between voice modal and other places)
  tradeoffRow: { marginBottom: 10 },
  tradeoffLabel: { fontSize: 11, color: "#94a3b8", marginBottom: 6 },
  ...
  tradeoffTagText: { fontSize: 12, color: "#475569" },

  // Shared inputs
  askRow: { flexDirection: "row", gap: 8, alignItems: "center" },
  askInput: { flex: 1, borderWidth: 1, borderColor: "#e2e8f0", borderRadius: 12, paddingHorizontal: 12, paddingVertical: 8, fontSize: 13, color: "#0f172a", backgroundColor: "#f8fafc" },
  askBtn: { backgroundColor: "#059669", borderRadius: 12, paddingHorizontal: 14, paddingVertical: 9, justifyContent: "center", alignItems: "center", minWidth: 48 },
  ...
  healthBarLabel: { fontSize: 10, color: "#64748b", width: 68, flexShrink: 0 },
  healthBarTrack: { flex: 1, height: 5, backgroundColor: "#f1f5f9", borderRadius: 3, overflow: "hidden" },
  healthBarFill: { height: 5, backgroundColor: "#059669", borderRadius: 3 },
  healthBarPts: { fontSize: 10, color: "#64748b", width: 28, textAlign: "right" },

  // Comparison
  compRow: { flexDirection: "row", alignItems: "center", gap: 6, flex: 1 },
  compName: { flex: 1, fontSize: 13, color: "#0f172a", fontWeight: "500" },
  compAmount: { fontSize: 12, color: "#64748b", marginRight: 4 },
  ...
  badgeNewText: { fontSize: 11, fontWeight: "600", color: "#7c3aed" },
  badgeGone: { backgroundColor: "#f1f5f9", borderRadius: 10, paddingHorizontal: 6, paddingVertical: 2 },
  badgeGoneText: { fontSize: 11, color: "#64748b" },

  // Patterns
  patternRow: { flexDirection: "row", alignItems: "flex-start", gap: 10, paddingVertical: 7, borderBottomWidth: 1, borderBottomColor: "#f1f5f9" },
  patternEmoji: { fontSize: 18 },
  patternText: { flex: 1, fontSize: 13, color: "#475569", lineHeight: 20 },
  patternBold: { fontWeight: "700", color: "#0f172a" },

  // Rewind
  rewindHeader: { fontSize: 11, color: "#94a3b8", fontStyle: "italic", marginBottom: 10 },
  ...
  socialOptInBtn: { backgroundColor: "#059669", borderRadius: 12, paddingVertical: 10, alignItems: "center" },
  socialOptInBtnText: { color: "#fff", fontWeight: "600", fontSize: 14 },
  ...
  socialBarLabel: { fontSize: 10, color: "#94a3b8", width: 24 },
  socialBarTrack: { flex: 1, height: 5, backgroundColor: "#f1f5f9", borderRadius: 3, overflow: "hidden" },
  socialBarFill: { height: 5, borderRadius: 3 },
  socialBarAmt: { fontSize: 10, color: "#64748b", width: 48, textAlign: "right" },
